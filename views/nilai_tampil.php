            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th scope="col">No.</th><th>NIS</th><th>Nama Siswa</th><th>Kelas</th><th>Mata Pelajaran</th><th>Guru</th><th>Nilai</th><th>Predikat</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                   ...
                                   <?php
                                    ...
                                    <?php
                                        $id = $data['id'];
                                        $mapel = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM mapel WHERE id='$id'"));
                                    ?>
                                    <td><?= $data['mapel'] ?></td>
                                    <?php
                                        $id = $data['id'];
                                        $guru = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM guru WHERE id='$id'"));
                                    ?>
                                    <td><?= $data['guru_mapel'] ?></td>
                                    <td><?= $data['nilai'] ?></td>
                                    <td><?= $data['predikat'] ?></td>
                                </tr>
