            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th scope="col">No.</th><th>NIP</th><th>Nama Guru</th><th>Mata Pelajaran</th><th>ACTIONS</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="?page=guru&actions=delete&id=<?php echo $data['id'] ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini ?')" class="btn btn-danger btn-xs">
