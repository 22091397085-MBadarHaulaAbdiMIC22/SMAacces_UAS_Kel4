        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span>Data Kelas</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th>Kelas</th><th>NIP Wali Kelas</th><th>Nama Wali Kelas</th><th>ACTIONS</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
									...
									<td><?= $data['wali_nama'] ?></td>
                                     ...
                                     <td>
                                        <a href="?page=kelas&actions=edit&id=<?= $data['id'] ?>" class="btn btn-warning btn-xs">
                                            <span class="glyphicon glyphicon-pencil"></span>edit
                                        </a>
                                        </a>
                                        <a href="?page=kelas&actions=delete&id=<?php echo $data['id'] ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini ?')" class="btn btn-danger btn-xs">
                         ...
                         <tfoot>
                            <tr>
                                <td colspan="4">
                                    <a href="?page=kelas&actions=tambah" class="btn btn-info btn-sm">
                                        Tambah Data Kelas
