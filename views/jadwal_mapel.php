            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                               <th scope="col">No.</th><th>Kelas</th><th>Mata Pelajaran</th><th>Jumlah Jam</th><th>Nama Guru</th><th>Hari</th><th>Waktu</th><th>ACTIONS</th>
                            </tr>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="?page=jadwal&actions=delete&id=<?php echo $data['id'] ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini ?')" class="btn btn-danger btn-xs">
