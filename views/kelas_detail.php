        ...
        <div class="col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Informasi Detail Kelas</h3>
                </div>
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped table-hover"> 
                        <tr>
                            <td width="200">Tingkat</td> <td><?= $data['tingkat'] ?></td>
                        </tr>
                        <tr>
                ...
                <div class="panel-footer">
                    <a href="?page=kelas&actions=tampil" class="btn btn-success btn-sm">
                        Kembali ke Data Kelas </a>
