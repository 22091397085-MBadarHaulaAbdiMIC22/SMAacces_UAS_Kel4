                    ...
                    <!--membuat form untuk tambah data-->
                     <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            <label for="nip" class="col-sm-3 control-label">NISN</label>
                               <div class="col-sm-9">
                         ...
                         <div class="form-group">
                            <label for="pegawai_jk" class="col-sm-3 control-label">Jurusan</label>
                            <div class="col-sm-2 col-xs-9">
                                <select name="pegawai_jk" class="form-control">
                                     <option value="Laki-laki"<?=$data['pegawai_jk']=='Laki-laki' ? 'selected' : null?>>Mipa</option>
                                    <option value="Perempuan"<?=$data['pegawai_jk']=='Perempuan' ? 'selected' : null?>>Ips</option>
                                </select>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="pegawai_agama" class="col-sm-3 control-label"></label>
                            <div class="col-sm-2 col-xs-9">
