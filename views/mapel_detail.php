        ...
        <div class="col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Informasi Detail Mata Pelajaran</h3>
                </div>
                <div class="panel-body">
                    <!--Menampilkan data detail arsip-->
                    <?php
                    $sql = "SELECT *FROM mapel WHERE id='" . $_GET ['id'] . "'";
                    ...
                    <table class="table table-bordered table-striped table-hover"> 
                        <tr>
                            <td width="200">Kode Mata Pelajaran</td> <td><?= $data['kd_mapel'] ?></td>
                        </tr>
                        <tr>
                            <td width="200">Nama Mata Pelajaran</td> <td><?= $data['mapel_nama'] ?></td>
                        </tr>
