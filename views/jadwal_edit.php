        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Update Data Jadwal Pelajaran</h3>
                </div>
                     ...
                     <form class="form-horizontal" action="" method="post">
                       <div class="form-group">
                           ...
                           <div class="col-sm-2 col-xs-9">
                                ...
                                ?>
                                    <option value="<?=$data2['kelas']?>" <?=$data['kelas']==$data2['kelas'] ? 'selected' : null?>><?=$data2['kelas']?></option>
                                <?php
                                    endwhile;
                                    endif;
                                ?>
                          ...
                          <div class="form-group">
                           ...
                           <div class="col-sm-2 col-xs-9">
                                ...
                                <?php
                                    ...
                                    while($data2 = mysqli_fetch_assoc($query)) :
                                ?>
                                    <option value="<?=$data2['mapel_nama']?>" <?=$data['nmapel']==$data2['mapel_nama'] ? 'selected' : null?>><?=$data2['kd_mapel']?></option>
                                <?php
                                    endwhile;
                                    endif;
                                ?>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-3 col-xs-9">
                                 <select name="jam" class="form-control">
                                    ...
                                    <option value="1" <?=$data['jam']=='1' ? 'selected' : null?>>1</option>
                                    <option value="2" <?=$data['jam']=='2' ? 'selected' : null?>>2</option>
                                    <option value="3" <?=$data['jam']=='3' ? 'selected' : null?>>3</option>
                                </select>
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                           ...
                           <div class="col-sm-3 col-xs-9">
                                ...
                                <?php
                                    ...
                                    while($data2 = mysqli_fetch_assoc($query)) :
                                ?>
                                <option value="<?=$data2['guru_nama']?>" <?=$data['guru']==$data2['guru_nama'] ? 'selected' : null?>><?=$data2['guru_nama']?></option>
                                <?php
                                    endwhile;
                                    endif;
                                ?>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-3 col-xs-9">
                                <select name="hari" class="form-control">
                                    ...
                                    <option value="Senin" <?=$data['hari']=='Senin' ? 'selected' : null?>>Senin</option>
                                    <option value="Selasa" <?=$data['hari']=='Selasa' ? 'selected' : null?>>Selasa</option>
                                    <option value="Rabu" <?=$data['hari']=='Rabu' ? 'selected' : null?>>Rabu</option>
                                    <option value="Kamis" <?=$data['hari']=='Kamis' ? 'selected' : null?>>Kamis</option>
                                    <option value="Jumat" <?=$data['hari']=='Jumat' ? 'selected' : null?>>Jumat</option>
                                    <option value="Sabtu" <?=$data['hari']=='Sabtu' ? 'selected' : null?>>Sabtu</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="waktu" class="col-sm-3 control-label">Waktu</label>
                               <div class="col-sm-9">
                                <input type="text" name="waktu" value="<?=$data['waktu']?>" class="form-control" id="inputEmail3" placeholder="Inputkan Waktu" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button type="submit" class="btn btn-success">
                                    <span class="fa fa-save"></span>Update Data Jadwal Pelajaran</button>
                            </div>
                        </div>
                    </form>
                ...
                <div class="panel-footer">
                    <a href="?page=jadwal&actions=mapel" class="btn btn-danger btn-sm">
                        Kembali Ke Data Jadwal Pelajaran
                    </a>
                </div>
            </div>
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE jadwal SET  kelas='$kelas', nmapel='$nmapel', jam='$jam', guru='$guru', hari='$hari', 
    waktu='$waktu'
    WHERE id ='$id'"; 
    $query=  mysqli_query($koneksi, $sql) or die ("SQL Edit Jadwal Pelajaran Error");
    if ($query){
